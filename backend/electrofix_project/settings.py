...
DATABASES = {
    'default': {
        'ENGINE': 'djongo',
        'NAME': config('MONGODB_NAME', default='electrofix'),
        'ENFORCE_SCHEMA': False,
        'CLIENT': {
            'host': config('MONGODB_HOST', default='mongodb'),
            'port': config('MONGODB_PORT', default=27017, cast=int),
            'username': config('MONGODB_USERNAME', default='admin'),
            'password': config('MONGODB_PASSWORD', default='password123'),
            'authSource': 'admin',
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'electrofix_app.utils.auth.JWTAuthentication',
    ],
...
# Custom user model
AUTH_USER_MODEL = 'electrofix_app.User'